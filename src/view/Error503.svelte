<main class="flex h-screen justify-center items-center bg-[#f3f9ff] flex-col">


<div>
  <h1 class="font-bold text-center text-lg mb-3">En este momento estamos presentando problemas con nuestro server, trabajamos fuerte para estar contigo pronto.</h1>
    <svg
      id="noConnection"
